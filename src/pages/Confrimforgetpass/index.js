...
const ConfirmForgotPass = ({ navigation }) => {
  ...
  return (
    <View style={[styles.root, { backgroundColor: '#252525', }]}>
      <View style={[styles.rectangle]}>
        ...
        <View >
          <Text style={{ color: '#ffff', fontSize: 18, fontWeight: 'bold', marginHorizontal: 30, marginBottom: 10 }}>Confirmation code</Text>
          <CustomInput />
          <Text style={{ color: '#ffff', fontSize: 18, fontWeight: 'bold', marginHorizontal: 30, marginBottom: 10 }}>New Password</Text>
          <CustomInput />
